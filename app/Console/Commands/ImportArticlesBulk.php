...
use App\Services\Article\ImportService;
use Illuminate\Console\Command;

class ImportArticlesBulk extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'articles:import-db-bulk
    ...
    public function handle(ImportService $importService): int
    {
        ...
        try {
            ...
            $result = match ($typeOption) {
                ...
                'opinions' => $importService->importArticles('opinions', $batchLimit, $totalLimit),
...
//                $this->line($e->getTraceAsString());
    ...
    php artisan db:seed
    php artisan articles:import-db-bulk --type=dict
    php artisan articles:import-db-bulk --type=users
    php artisan articles:import-db-bulk --type=opinions_author
    php artisan articles:import-db-bulk --type=publications
    php artisan articles:import-db-bulk --type=opinions     !!! IMPORTANT
    php artisan articles:import-db-bulk --type=opinionsnew
    php artisan articles:import-db-bulk --type=persons
    php artisan articles:import-db-bulk --type=company
