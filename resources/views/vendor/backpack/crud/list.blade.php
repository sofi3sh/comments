...
@section('header')
    <section class="header-operation container-fluid animated fadeIn d-flex flex-column mb-2 align-items-center d-print-none" bp-section="page-header">
        <h1 class="text-capitalize mb-0" bp-section="page-heading">{!! $crud->getHeading() ?? $crud->entity_name_plural !!}</h1>
        <p class="mb-0" id="datatable_info_stack" bp-section="page-subheading">{!! $crud->getSubheading() ?? '' !!}</p>
    </section>
@endsection
  ...
  <div class="row" bp-section="crud-operation-list">
    ...
    <div class="{{ $crud->getListContentClass() }}">
        ...
        <div class="row mb-2 align-items-center">
          ...
          <div class="col-sm-4">
            <div id="datatable_search_stack" class="mt-sm-0 mt-2 d-print-none d-flex align-items-center gap-2">
              @include('crud::inc.button_stack', ['stack' => 'search'])
              <div class="input-icon flex-grow-1" style="min-width: 0;">
...
@section('after_scripts')
  ...
  @include('admin.charts.chart-modal')
