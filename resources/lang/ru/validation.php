...
return [
    ...
    */
    ...
    'declined_if'          => 'Аттрибут :attribute должен быть отклонен, если :other равно :valueю',
    ...
    'enum'                 => 'Выьранный аттрибут :attribute неверный.',
    ...
    'max_digits'  => 'Поле :attribute должно быть не больше :max.',
    ...
    'gte' => [
        ...
        'file'    => 'Поле :attribute должно быть больше или равен :value килобайтам.',
        'numeric' => 'Поле :attribute должно быть больше или равен :value.',
        'string'  => 'Поле :attribute должно быть больше или равен символам :value.',
    ],
    'lt' => [
        'array'   => 'Поле :attribute должно иметь меньше чем :value items.',
        'file'    => 'Поле :attribute должно быть меньше чем :value kilobytes.',
        'numeric' => 'Поле :attribute должно быть меньше чем :value.',
        'string'  => 'Поле :attribute должно быть меньше чем :value символов.',
    ],
    'lte' => [
        'array'   => 'Поле :attribute не должно иметь больше чем :value элементов.',
        'file'    => 'Поле :attribute должно быть меньше или равно :value kilobytes.',
        'numeric' => 'Поле :attribute должно быть меньше или равно :value.',
        'string'  => 'Поле :attribute должно быть меньше или равно :value элементов.',
    ],
    'mac_address' => 'Поле :attribute должно быть корректным MAC address.',
    'multiple_of' => 'Поле :attribute должно быть кратно :value.',
    'not_regex' => 'Формат поля :attribute не правильный.',
